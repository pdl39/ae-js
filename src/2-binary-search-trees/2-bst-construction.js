...
// console.log(bst2.insert(5));
// console.log(bst2.insert(15));
// console.log(bst2.contains(10));
// console.log(bst2.contains(5));
// console.log(bst2.contains(15));
// console.log(bst2.remove(10));
// console.log(bst2.remove(15));
// console.log(bst2.remove(5));
// console.log(bst2.contains(10));
// console.log(bst2.contains(5));
// console.log(bst2.contains(15));

// const bst3 = new BST(1);
// console.log(bst3.insert(2));
// console.log(bst3.insert(3));
// console.log(bst3.insert(4));
// console.log(bst3.remove(1));

const bst4 = new BST(10);
console.log(bst4.insert(5));
console.log(bst4.insert(15));
console.log(bst4.insert(2));
console.log(bst4.insert(5));
console.log(bst4.insert(13));
console.log(bst4.insert(22));
console.log(bst4.insert(1));
console.log(bst4.insert(14));
console.log(bst4.insert(12));
console.log(bst4.remove(5));
console.log(bst4.remove(5));
console.log(bst4.remove(12));
console.log(bst4.remove(13));
console.log(bst4.remove(14));
console.log(bst4.remove(22));
console.log(bst4.remove(2));
console.log(bst4.remove(1));
console.log(bst4.contains(15));